...
const ALL_COMMANDS: Command[] = [
  ...
  { id: "reasoning", label: "/reasoning", description: "Set reasoning level (low/medium/high/max)", category: "Model", command: "/reasoning" },
  ...
  { id: "setup", label: "/setup", description: "Open setup menu", category: "System", command: "/setup" },
